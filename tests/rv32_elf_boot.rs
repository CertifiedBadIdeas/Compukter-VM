...
const MARKER: &[u8] = b"RV32 ELF BOOT OK\n";

#[test]
#[ignore = "requires the stock Clang/LLD RV32 fixture"]
fn stock_toolchain_rv32_elf_boots_and_halts() {
    let path = std::env::var_os("RV32_ELF_BOOT_FIXTURE")
        .expect("RV32_ELF_BOOT_FIXTURE must name the compiled ELF");
