...
const MARKER: &[u8] = b"RV32 TRAP OK\n";

#[test]
#[ignore = "requires the stock Clang/LLD RV32 trap fixture"]
fn stock_toolchain_rv32_elf_handles_ecall_and_returns() {
    let path = std::env::var_os("RV32_ELF_TRAP_FIXTURE")
        .expect("RV32_ELF_TRAP_FIXTURE must name the compiled ELF");
