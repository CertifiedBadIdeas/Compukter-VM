...
pub const COMPUKTER_FFI_ABI_VERSION: u32 = 10;
...
pub use ffi_api::{
    ...
    compukter_resource_snapshot, compukter_resume_failure, compukter_resume_string,
    compukter_resume_unit, compukter_store_close, compukter_store_durable_generation,
