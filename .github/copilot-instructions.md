# Copilot / agent instructions for Compukter-VM
...
repo: CertifiedBadIdeas/Compukter-VM
project_number: 1
...
- First content line under the `# Title` MUST be `> Issue: [#N](https://github.com/CertifiedBadIdeas/Compukter-VM/issues/N)`.
