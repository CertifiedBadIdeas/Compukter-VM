...
the raw report remain under `target/rv32-c-comparison/`. This
...
in the [Compukter Kraft RV32 decision](https://github.com/CertifiedBadIdeas/Compukter-Kraft/blob/dev/docs/architecture-decisions/0001-adopt-rv32.md).
