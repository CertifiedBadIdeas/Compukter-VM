...
pub struct ArtifactLimits {
    ...
    pub physical_components_per_value: usize,
    pub safepoints_per_function: usize,
    pub roots_per_safepoint: usize,
    pub imports: usize,
...
impl Default for ArtifactLimits {
    fn default() -> Self {
        Self {
            ...
            physical_components_per_value: u16::MAX as usize,
            safepoints_per_function: 1_000_000,
            roots_per_safepoint: u16::MAX as usize,
            imports: 1_000_000,
