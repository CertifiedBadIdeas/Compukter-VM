...
fn managed_heap_vertical_conformance() {
    ...
    assert_eq!(
        (
            [69, 7, 12],
            [
                53, 230, 57, 57, 212, 234, 31, 18, 133, 230, 109, 254, 179, 117, 108, 222, 153,
                148, 202, 169, 197, 95, 13, 218, 224, 87, 62, 228, 27, 225, 54, 203,
            ],
        ),
        observation
    );
...
fn straight_line_trace_digest_matches_documented_field_encoding() {
    ...
    assert_eq!(
        [
            151, 108, 90, 222, 201, 3, 54, 117, 188, 106, 18, 217, 130, 135, 42, 203, 128, 100, 20,
            138, 15, 232, 16, 80, 214, 121, 142, 153, 176, 26, 7, 178
        ],
